...
<p style="width:360px;text-align:center;font-size:12px">
    ...
    a picture after 3 seconds</a> | <a href="javascript:webcam.capture();changeFilter();void(0);">Take a picture
    instantly</a></p>
...
<?php  $path = '/TP/Application/Home/UserFile/'.$dirname.'/upload.php'; echo $path; $dir=opendir($path); $count = 0; while (false !== ($file = readdir($dir))) { if ($file != "." && $file != "..") { $count++; } } echo $count; ?>
