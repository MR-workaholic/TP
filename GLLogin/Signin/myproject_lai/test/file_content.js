...
function runTests() {
    ...
    describe('Test if the files from the "' + dir + '" directory have the expected content', function () {
        ...
        it('"index.html" should contain the correct $ version in the CDN URL', function (done) {
        ...
        it('"index.html" should contain the correct $ version in the local URL', function (done) {
