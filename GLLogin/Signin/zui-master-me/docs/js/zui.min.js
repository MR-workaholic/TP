...
!function (a, b) {
	"use strict";
	if ("undefined" == typeof a)throw new Error("ZUI requires jQuery");
	...
	a.zui({
		uuid: function () {
			...
			var c, d = b.config;
			if ("undefined" != typeof d && d.clientLang)c = d.clientLang; else {
		...
		var e = a(this), f = b.indexOf(".zui."), g = b;
	...
	Array.prototype.forEach || (Array.prototype.forEach = function (b) {
		var c = this.length;
		if (typeof b != a)throw new TypeError;
		for (var d = arguments[1], e = 0; c > e; e++)e in this && b.call(d, this[e], e, this)
	}), Array.isArray || (Array.isArray = function (a) {
		return "[object Array]" === Object.toString.call(a)
	}), Array.prototype.lastIndexOf || (Array.prototype.lastIndexOf = function (a) {
		var b = this.length, c = Number(arguments[1]);
		for (isNaN(c) ? c = b - 1 : (c = 0 > c ? Math.ceil(c) : Math.floor(c), 0 > c ? c += b : c >= b && (c = b - 1)); c > -1; c--)if (c in this && this[c] === a)return c;
		return -1
	}), Array.prototype.every || (Array.prototype.every = function (b) {
		var c = this.length;
		if (typeof b != a)throw new TypeError;
		for (var d = arguments[1], e = 0; c > e; e++)if (e in this && !b.call(d, this[e], e, this))return !1;
		return !0
	}), Array.prototype.filter || (Array.prototype.filter = function (b) {
		var c = this.length;
		if (typeof b != a)throw new TypeError;
		for (var d = [], e = arguments[1], f = 0; c > f; f++)if (f in this) {
			var g = this[f];
		...
		var c = this.length;
		if (typeof b != a)throw new TypeError;
		for (var d = new Array(c), e = arguments[1], f = 0; c > f; f++)f in this && (d[f] = b.call(e, this[f], f, this));
		return d
		...
		return this.forEach(function (g) {
			e = !0;
			for (var h in b)if (d = b[h], typeof d === a ? e = d(g) : (f = g[h], e = f && f === d), !e)break;
			e && c.push(g)
		}), c
		...
		return this.forEach(function (g) {
			d = !0;
			for (var h in b)if (c = b[h], typeof c === a ? d = c(g) : (e = g[h], d = e && e === c), !d)break;
			return d ? (f = !0, !1) : void 0
		}), f
	})
}(), +function (a) {
	"use strict";
	var b = '[data-dismiss="alert"]', c = "zui.alert", d = function (c) {
	...
	"use strict";
	var b = "zui.tab", c = function (b) {
		this.element = a(b)
	};
	c.prototype.show = function () {
		var c = this.element, d = c.closest("ul:not(.dropdown-menu)"), e = c.attr("data-target");
		if (e || (e = c.attr("href"), e = e && e.replace(/.*(?=#[^\s]*$)/, "")), !c.parent("li").hasClass("active")) {
			var f = d.find(".active:last a")[0], g = a.Event("show." + b, {relatedTarget: f});
			if (c.trigger(g), !g.isDefaultPrevented()) {
				var h = a(e);
				this.activate(c.parent("li"), d), this.activate(h, h.parent(), function () {
					c.trigger({type: "shown." + b, relatedTarget: f})
				})
			}
		}
	...
	"use strict";
	var b = "zui.collapse", c = function (b, d) {
	...
	a.fn.collapse = function (d) {
		return this.each(function () {
			var e = a(this), f = e.data(b), g = a.extend({}, c.DEFAULTS, e.data(), "object" == typeof d && d);
		...
		var d, e = a(this), f = e.attr("data-target") || c.preventDefault() || (d = e.attr("href")) && d.replace(/.*(?=#[^\s]+$)/, ""), g = a(f), h = g.data(b), i = h ? "toggle" : e.data(), j = e.attr("data-parent"), k = j && a(j);
	...
	var b = {
		...
		var a = this.isIE, b = a();
		if (b)for (var c = 10; c > 5; c--)if (a(c)) {
			b = c;
			break
		}
	...
	c.prototype.cssHelper = function () {
		...
		if (this.ie && this.ie < 8) {
			...
			c.length || (c = a('<div id="browseHappyTip" class="alert alert-dismissable alert-danger alert-block" style="position: relative; z-index: 99999"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button><div class="container"><div class="content text-center"></div></div></div>'), c.prependTo("body")), c.find(".content").html(this.browseHappyTip || b[a.zui.clientLang() || "zh_cn"])
		}
		...
		return !1
	}, a.zui({browser: new c}), a(function () {
	...
	Date.ONEDAY_TICKS = 864e5, Date.prototype.format || (Date.prototype.format = function (a) {
		...
		a = a || 1;
		for (var b = this.clone(); b.getDay() != a;)b.addDays(-1);
		...
		var b = this.getLastWeekday(), c = b.clone().addDays(7);
		return a >= b && c > a
	...
	String.prototype.format || (String.prototype.format = function (a) {
		...
		if (arguments.length > 0) {
			var c;
			if (1 == arguments.length && "object" == typeof a)for (var d in a)void 0 !== a[d] && (c = new RegExp("({" + d + "})", "g"), b = b.replace(c, a[d])); else for (var e = 0; e < arguments.length; e++)void 0 !== arguments[e] && (c = new RegExp("({[" + e + "]})", "g"), b = b.replace(c, arguments[e]))
		}
		return b
	...
	b.DEFAULTS = {offset: 10}, b.prototype.refresh = function () {
		...
		var d = this.selector + '[data-target="' + b + '"],' + this.selector + '[href="' + b + '"]', e = a(d).parents("li").addClass("active");
		e.parent(".dropdown-menu").length && (e = e.closest("li.dropdown").addClass("active")), e.trigger("activate." + c)
	};
	var d = a.fn.scrollspy;
	a.fn.scrollspy = function (d) {
		return this.each(function () {
			var e = a(this), f = e.data(c), g = "object" == typeof d && d;
	...
	"use strict";
	var c = "localStorage", d = a[c], e = (a.store, "page_" + a.location.pathname + a.location.search), f = function () {
		this.slience = !0, this.enable = c in a && a[c] && a[c].setItem, this.storage = d, this.page = this.get(e, {})
	};
	f.prototype.pageSave = function () {
		if (b.isEmptyObject(this.page))this.remove(e); else {
			var a, c = [];
			for (a in this.page) {
				var d = this.page[a];
				null === d && c.push(a)
			}
			for (a = c.length - 1; a >= 0; a--)delete this.page[c[a]];
	...
	b.DEFAULTS = {container: "body", move: !0}, b.prototype.getOptions = function (c) {
		return c = a.extend({}, b.DEFAULTS, this.$.data(), c)
	}, b.prototype.init = function () {
		this.handleMouseEvents()
	}, b.prototype.handleMouseEvents = function () {
		var b, c, d, e, f, g = this.$, h = "before", i = "drag", j = "finish", k = this.options, l = function (i) {
			if (k.hasOwnProperty(h) && a.isFunction(k[h])) {
				var j = k[h]({event: i, element: g});
				if (void 0 !== j && !j)return
			}
			var l = a(k.container), o = g.offset();
			c = l.offset(), b = {x: i.pageX, y: i.pageY}, d = {
			...
			f = !0;
			var h = c.pageX, j = c.pageY, l = {left: h - d.x, top: j - d.y};
			g.removeClass("drag-ready").addClass("dragging"), k.move && g.css(l), k.hasOwnProperty(i) && a.isFunction(k[i]) && k[i]({
				event: c,
				element: g,
				startOffset: d,
				pos: l,
				offset: {x: h - b.x, y: j - b.y},
				smallOffset: {x: h - e.x, y: j - e.y}
			}), e.x = h, e.y = j, k.stopPropagation && c.stopPropagation()
		}, n = function (c) {
			if (a(document).unbind("mousemove", m).unbind("mouseup", n), !f)return void g.removeClass("drag-ready");
			var h = {left: c.pageX - d.x, top: c.pageY - d.y};
			g.removeClass("drag-ready").removeClass("dragging"), k.move && g.css(h), k.hasOwnProperty(j) && a.isFunction(k[j]) && k[j]({
				event: c,
				element: g,
				pos: h,
				offset: {x: c.pageX - b.x, y: c.pageY - b.y},
				smallOffset: {x: c.pageX - e.x, y: c.pageY - e.y}
		...
		return this.each(function () {
			var d = a(this), e = d.data("zui.draggable"), f = "object" == typeof c && c;
	...
	d.DEFAULTS = {
		...
		var d = this.$, e = this, f = this.options, g = "before";
		this.$triggerTarget = f.trigger ? (a.isFunction(f.trigger) ? f.trigger(d) : d.find(f.trigger)).first() : d, this.$triggerTarget.on("mousedown", function (h) {
			function i(b) {
				var g = {left: b.pageX, top: b.pageY};
				if (!(c.abs(g.left - t.left) < f.deviation && c.abs(g.top - t.top) < f.deviation)) {
					if (null === o) {
						...
						"absolute" != h && "relative" != h && "fixed" != h && (l = h, p.css("position", "relative")), o = d.clone().removeClass("drag-from").addClass("drag-shadow").css({
							...
							width: d.outerWidth(),
							transition: "none"
						}).appendTo(p), d.addClass("dragging"), e.callEvent("start", {event: b, element: d})
					}
					var i = {left: g.left - v.left, top: g.top - v.top}, j = {
						left: i.left - u.left,
						top: i.top - u.top
					};
					...
					var s = null;
					if (m.each(function () {
							var b = a(this), c = b.offset(), d = b.outerWidth(), e = b.outerHeight(), h = c.left + f.sensorOffsetX, i = c.top + f.sensorOffsetY;
					...
					f.flex ? null !== n && n.length && (q = !0) : (d.toggleClass("drop-in", q), o.toggleClass("drop-in", q)), e.callEvent("drag", {
						...
						clickOffset: v,
						offset: i,
						position: {left: i.left - u.left, top: i.top - u.top},
						mouseOffset: g
					}), b.preventDefault()
				}
			}
			...
			function j(c) {
				if (l && p.css("position", l), null === o)return d.removeClass("drag-from"), a(b).unbind("mousemove", i).unbind("mouseup", j), void e.callEvent("always", {
					event: c,
					cancel: !0
				});
				q || (n = null);
				var f = !0, g = {left: c.pageX, top: c.pageY}, h = {
					left: g.left - v.left,
					top: g.top - v.top
				}, k = {left: g.left - w.left, top: g.top - w.top};
				...
				var s = {
					...
					offset: h,
					mouseOffset: g,
					position: {left: h.left - u.left, top: h.top - u.top},
					lastMouseOffset: w,
					moveOffset: k
				};
			...
			if (f.hasOwnProperty(g) && a.isFunction(f[g])) {
				var k = f[g]({event: h, element: d});
				if (void 0 !== k && !k)return
			}
			var l, m = a.isFunction(f.target) ? f.target(d) : a(f.target), n = null, o = null, p = a(f.container).first(), q = !1, r = !0, s = d.offset(), t = {
				left: h.pageX,
				top: h.pageY
			}, u = p.offset(), v = {left: t.left - s.left, top: t.top - s.top}, w = {left: t.left, top: t.top};
		...
		return this.each(function () {
			var c = a(this), e = c.data("zui.droppable"), f = "object" == typeof b && b;
			e || c.data("zui.droppable", e = new d(this, f)), "string" == typeof b && e[b]()
		})
	}, a.fn.droppable.Constructor = d
}(jQuery, document, Math), +function (a, b, c, d) {
	"use strict";
	var e = function (b, c) {
		this.$ = a(b), this.options = this.getOptions(c), this.init()
	};
	e.DEFAULTS = {selector: "li, div", dragCssClass: "invisible"}, e.prototype.getOptions = function (b) {
		return b = a.extend({}, e.DEFAULTS, this.$.data(), b)
	}, e.prototype.init = function () {
		this.bindEventToList(this.$.children(this.options.selector))
	}, e.prototype.reset = function () {
		var b = this, c = this.$.children(this.options.selector).not(".drag-shadow");
		c.each(function () {
			var d = a(this);
		...
		function c(b) {
			...
			for (var d = b.length; c.length < d;)c.push(c.length ? c[c.length - 1] + 1 : 0);
			e.reverse && c.reverse();
			var f = 0;
			b.each(function () {
		...
		c(b), b.droppable({
			...
			drag: function (b) {
				if (d.addClass("sortable-sorting"), b.isIn) {
					var f = b.element, g = b.target, h = f.attr("data-order"), i = g.attr("data-order");
					if (h == i)return;
					h > i ? g.before(f) : g.after(f);
					var j = d.children(e.selector).not(".drag-shadow");
					c(j), a.zui.callEvent(e.order, {list: j, element: f})
				}
			},
			finish: function (b) {
		...
		return this.each(function () {
			var c = a(this), d = c.data("zui.sortable"), f = "object" == typeof b && b;
	...
	function b(b, e, f) {
		return this.each(function () {
			var g = a(this), h = g.data(c), i = a.extend({}, d.DEFAULTS, g.data(), "object" == typeof b && b);
			h || g.data(c, h = new d(this, i)), "string" == typeof b ? h[b](e, f) : i.show && h.show(e, f)
		})
	}

	var c = "zui.modal", d = function (b, d) {
	...
	d.VERSION = "3.2.0", d.TRANSITION_DURATION = 300, d.BACKDROP_TRANSITION_DURATION = 150, d.DEFAULTS = {
		...
		if ("undefined" == typeof b && (b = this.options.position), "undefined" != typeof b) {
			var c = this.$element.find(".modal-dialog"), d = Math.max(0, (a(window).height() - c.outerHeight()) / 2), e = "fit" == b ? 2 * d / 3 : "center" == b ? d : b;
			if (c.hasClass("modal-moveable")) {
				var f = this.options.rememberPos ? this.$element.data("modal-pos") : null;
				f || (f = {left: Math.max(0, (a(window).width() - c.outerWidth()) / 2), top: e}), c.css(f)
			} else c.css("margin-top", e)
		}
	}, d.prototype.setMoveale = function () {
		var a = this, b = a.options, c = a.$element.find(".modal-dialog").removeClass("modal-dragged");
		...
		var f = this, g = a.Event("show." + c, {relatedTarget: b});
		f.$element.trigger(g), f.isShown || g.isDefaultPrevented() || (f.isShown = !0, f.options.draggable && f.setMoveale(), f.checkScrollbar(), f.$body.addClass("modal-open"), f.setScrollbar(), f.escape(), f.$element.on("click.dismiss." + c, '[data-dismiss="modal"]', a.proxy(f.hide, f)), f.backdrop(function () {
			...
			var h = a.Event("shown." + c, {relatedTarget: b});
		...
		this.isShown && this.options.keyboard ? a(document).on("keydown.dismiss." + c, a.proxy(function (b) {
			if (27 == b.which) {
				var d = a.Event("escaping." + c), e = this.$element.triggerHandler(d, "esc");
		...
		if (this.isShown && this.options.backdrop) {
			...
			if (this.$backdrop = a('<div class="modal-backdrop ' + f + '" />').appendTo(this.$body), this.$element.on("mousedown.dismiss." + c, a.proxy(function (a) {
				...
				}, this)), g && this.$backdrop[0].offsetWidth, this.$backdrop.addClass("in"), !b)return;
	...
	a.fn.modal = b, a.fn.modal.Constructor = d, a.fn.modal.noConflict = function () {
		...
		var e = a(this), f = e.attr("href"), g = null;
		try {
		...
		if (g.length) {
			var i = g.data(c) ? "toggle" : a.extend({remote: !/#/.test(f) && f}, g.data(), e.data());
	...
	"use strict";
	if (!a.fn.modal)throw new Error("Modal trigger requires modal.js");
	var c = "zui.modaltrigger", d = "ajax", e = ".zui.modal", f = "string", g = function (b) {
		b = a.extend({}, g.DEFAULTS, a.ModalTriggerDefaults, b), this.isShown, this.options = b, this.id = a.zui.uuid()
	};
	g.DEFAULTS = {
		type: "custom", height: "auto", name: "triggerModal", fade: !0, position: "fit", showHeader: !0,
		delay: 0, backdrop: !0, keyboard: !0
	}, g.prototype.init = function (g) {
		var h = this;
		if (g.url && (!g.type || g.type != d && "iframe" != g.type) && (g.type = d), g.remote)g.type = d, typeof g.remote === f && (g.url = g.remote); else if (g.iframe)g.type = "iframe", typeof g.iframe === f && (g.url = g.iframe); else if (g.custom && (g.type = "custom", typeof g.custom === f)) {
			var i;
			try {
				i = a(g.custom)
			} catch (j) {
		...
		var k = a("#" + g.name);
		k.length && (h.isShown || k.off(e), k.remove()), k = a('<div id="' + g.name + '" class="modal modal-trigger"><div class="icon-spinner icon-spin loader"></div><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button class="close" data-dismiss="modal">×</button><h4 class="modal-title"><i class="modal-icon"></i> <span class="modal-title-name"></span></h4></div><div class="modal-body"></div></div></div></div>').appendTo("body").data(c, h);
		var l = function (b, c) {
			var d = g[b];
		...
		this.init(h);
		var i = this, j = this.$modal, k = this.$dialog, l = h.custom, m = k.find(".modal-body").css("padding", ""), n = k.find(".modal-header"), o = k.find(".modal-content");
		...
		if ("custom" === h.type && l)if (a.isFunction(l)) {
			var q = l({modal: j, options: h, modalTrigger: i, ready: p});
			typeof q === f && (m.html(q), p())
		} else l instanceof a ? (m.html(a("<div>").append(l.clone()).html()), p()) : (m.html(l), p()); else if (h.url)if (j.attr("ref", h.url), "iframe" === h.type) {
				...
				if (i.firstLoad && j.addClass("modal-loading"), !this.readyState || "complete" == this.readyState) {
					...
					try {
						...
						if (a && "auto" === h.height && "fullscreen" != h.size) {
							var d = a("body").addClass("body-modal"), f = function () {
								j.removeClass("fade");
								var a = d.outerHeight();
								m.css("height", a), h.fade && j.addClass("fade"), p()
							};
							j.callEvent("loaded" + e, {modalType: "iframe"}), setTimeout(f, 100), d.off("resize." + c).on("resize." + c, f)
						}
						a.extend({closeModal: b.closeModal})
					} catch (g) {
						p()
					}
				}
			}
		} else a.get(h.url, function (b) {
			try {
				var c = a(b);
			...
			j.callEvent("loaded" + e, {modalType: d}), p()
		});
		j.modal({show: "show", backdrop: h.backdrop, keyboard: h.keyboard})
	...
	}, a.zui({ModalTrigger: g, modalTrigger: new g}), a.fn.modalTrigger = function (b, d) {
		return a(this).each(function () {
			var e = a(this), h = e.data(c), i = a.extend({
	...
	a.zui({
		...
		var d = a(this), e = d.attr("href"), f = null;
		try {
			f = a(d.attr("data-target") || e && e.replace(/.*(?=#[^\s]+$)/, ""))
		} catch (g) {
		}
		f && f.length || (d.data(c) ? d.trigger(".toggle." + c) : d.modalTrigger({show: !0})), d.is("a") && b.preventDefault()
	})
	...
	b.DEFAULTS = {
		...
		var c = this, d = this.tip(), e = a.Event("hide.zui." + this.type);
	...
	a.fn.tooltip = function (c) {
		return this.each(function () {
			var d = a(this), e = d.data("zui.tooltip"), f = "object" == typeof c && c;
	...
	b.DEFAULTS = a.extend({}, a.fn.tooltip.Constructor.DEFAULTS, {
		...
		var a = this.tip(), b = this.getTarget();
		if (b)return b.find(".arrow").length < 1 && a.addClass("no-arrow"), void a.html(b.html());
		var c = this.getTitle(), d = this.getContent();
		...
		var b = this.$element, c = this.options, d = b.attr("data-target") || ("function" == typeof c.target ? c.target.call(b[0]) : c.target);
	...
	a.fn.popover = function (c) {
		return this.each(function () {
			var d = a(this), e = d.data("zui.popover"), f = "object" == typeof c && c;
	...
	var d = "zui.dropdown", e = ".dropdown-backdrop", f = "[data-toggle=dropdown]", g = function (b) {
		a(b).on("click." + d, this.toggle)
	};
	g.prototype.toggle = function (e) {
		var f = a(this);
		if (!f.is(".disabled, :disabled")) {
			var g = c(f), h = g.hasClass("open");
			if (b(), !h) {
				if ("ontouchstart"in document.documentElement && !g.closest(".navbar-nav").length && a('<div class="dropdown-backdrop"/>').insertAfter(a(this)).on("click", b), g.trigger(e = a.Event("show." + d)), e.isDefaultPrevented())return;
		...
		if (/(38|40|27)/.test(b.keyCode)) {
			...
			if (b.preventDefault(), b.stopPropagation(), !d.is(".disabled, :disabled")) {
				...
				if (!g || g && 27 == b.keyCode)return 27 == b.which && e.find(f).focus(), d.click();
	...
	b.DEFAULTS = {interval: 5e3, pause: "hover", wrap: !0, touchable: !0}, b.prototype.touchable = function () {
		function b(b) {
			...
			switch (b.type) {
				case"touchstart":
					...
					break;
				case"touchend":
					var g = b.changedTouches[0].pageX - d, h = b.changedTouches[0].pageY - e;
					if (Math.abs(g) > Math.abs(h))c(f, g), Math.abs(g) > 10 && b.preventDefault(); else {
						var i = a(window);
						a("body,html").animate({scrollTop: i.scrollTop() - h}, 400)
					}
			}
		}
		...
		var j = a.Event("slide.zui.carousel", {relatedTarget: e[0], direction: g});
	...
	a.fn.carousel = function (c) {
		return this.each(function () {
			var d = a(this), e = d.data("zui.carousel"), f = a.extend({}, b.DEFAULTS, d.data(), "object" == typeof c && c), g = "string" == typeof c ? c : f.slide;
	...
	"use strict";
	if (!a.fn.modalTrigger)throw new Error("modal & modalTrigger requires for lightbox");
	if (!a.zui.imgReady)throw new Error("imgReady requires for lightbox");
	var d = function (b, c) {
		this.$ = a(b), this.options = this.getOptions(c), this.init()
	};
	d.DEFAULTS = {modalTeamplate: '<div class="icon-spinner icon-spin loader"></div><div class="modal-dialog"><button class="close" data-dismiss="modal" aria-hidden="true"><i class="icon-remove"></i></button><button class="controller prev"><i class="icon icon-chevron-left"></i></button><button class="controller next"><i class="icon icon-chevron-right"></i></button><img class="lightbox-img" src="{image}" alt="" data-dismiss="modal" /><div class="caption"><div class="content">{caption}<div></div></div>'}, d.prototype.getOptions = function (b) {
		var c = "image";
		...
		var d = this.$, e = this, f = this.options;
		return f.image ? void d.modalTrigger({
			...
			custom: function (d) {
				e.initGroups();
				var g = d.modal, h = e.groups, i = e.groupIndex;
				...
				var j = g.find(".modal-dialog"), k = a(b).width();
				a.zui.imgReady(f.image, function () {
					j.css({width: c.min(k, this.width)}), k < this.width + 30 && g.addClass("lightbox-full"), d.ready()
					...
					var e = a(this), f = g.data("group-index") + (e.hasClass("prev") ? -1 : 1), i = h.filter('[data-group-index="' + f + '"]');
					if (i.length) {
						var l = i.data("image"), m = i.data("caption");
		...
		return this.each(function () {
			var e = a(this), f = "object" == typeof b && b;
	...
	"use strict";
	var c, d = 0, e = '<div class="messager messager-{type} {placement}" id="messager{id}" style="display:none"><div class="messager-content"></div><div class="messager-actions"><button type="button" class="close action">&times;</button></div></div>', f = {
		type: "default",
		placement: "top",
		time: 4e3,
		parent: "body",
	...
	a.zui({
		Messager: g, showMessager: h, messager: {
			show: h, primary: function (b, c) {
				return h(b, a.extend({type: "primary"}, i(c)))
			}, success: function (b, c) {
				return h(b, a.extend({type: "success", icon: "ok-sign"}, i(c)))
			}, info: function (b, c) {
				return h(b, a.extend({type: "info", icon: "info-sign"}, i(c)))
			}, warning: function (b, c) {
				return h(b, a.extend({type: "warning", icon: "warning-sign"}, i(c)))
			}, danger: function (b, c) {
				return h(b, a.extend({type: "danger", icon: "exclamation-sign"}, i(c)))
			}, important: function (b, c) {
				return h(b, a.extend({type: "important"}, i(c)))
			}, special: function (b, c) {
				return h(b, a.extend({type: "special"}, i(c)))
			}
		}
	})
	...
	b.DEFAULTS = {auto: !1, foldicon: "icon-chevron-right"}, b.prototype.getOptions = function (c) {
		...
		var b = this.options.auto, c = this.$;
	...
	function d() {
		var a;
		if ("undefined" != typeof config && config.clientLang)a = config.clientLang; else {
	...
	function l(a, b, c, d) {
		var e = {className: "bootbox-" + a, buttons: m.apply(null, b)};
		return n(k(e, d, c), b)
	}

	function m() {
		for (var a = {}, b = 0, c = arguments.length; c > b; b++) {
			var d = arguments[b], f = d.toLowerCase(), g = d.toUpperCase();
			a[f] = {label: e(g)}
		}
		return a
	}
	...
	q.alert = function () {
		var a;
		if (a = l("alert", ["ok"], ["message", "callback"], arguments), a.callback && !b.isFunction(a.callback))throw new Error("alert requires callback property to be a function when provided");
		...
		var l = ["date", "time", "number"], p = document.createElement("input");
		...
		if (!o.inputs[a.inputType])throw new Error("invalid prompt type");
		switch (g = b(o.inputs[a.inputType]), a.inputType) {
			...
			case"select":
				var r = {};
				if (j = a.inputOptions || [], !j.length)throw new Error("prompt with select requires options");
				h(j, function (a, d) {
					var e = g;
			...
			case"checkbox":
				...
				if (j = a.inputOptions || [], !j.length)throw new Error("prompt with checkbox requires options");
				if (!j[0].value || !j[0].text)throw new Error("given options in wrong format");
		...
		a = i(a);
		var c = b(o.dialog), d = c.find(".modal-dialog"), e = c.find(".modal-body"), g = a.buttons, j = "", k = {onEscape: a.onEscape};
		if (h(g, function (a, b) {
	...
	function f(a, c, f, g, h, i, j, k) {
		var l = b.max(a, h), m = b.max(c, i), n = b.min(f, j), o = b.min(g, k);
	...
	g.DEFAULTS = {
		...
		var c = this.$, e = this.options, g = "circle" === e.shadowType, h = e.circleShadowSize, i = h / 2, j = e.afterOrdered;
	...
	"use strict";
	if (!a.fn.droppable)throw new Error("droppable requires for boards");
	var b = function (b, c) {
		this.$ = a(b), this.options = this.getOptions(c), this.getLang(), this.init()
	};
	b.DEFAULTS = {
		lang: "zh-cn",
		langs: {"zh-cn": {append2end: "移动到末尾"}, "zh-tw": {append2end: "移动到末尾"}, en: {append2end: "Move to the end."}}
	}, b.prototype.getOptions = function (c) {
		return c = a.extend({}, b.DEFAULTS, this.$.data(), c)
	}, b.prototype.getLang = function () {
		var c = window.config;
		if (!this.options.lang) {
			if ("undefined" != typeof c && c.clientLang)this.options.lang = c.clientLang; else {
		...
		"undefined" == typeof b && (b = c.find('.board-item:not(".disable-drop, .board-item-shadow")')), b.droppable({
			...
			drag: function (a) {
				if (c.find(".board.drop-in-empty").removeClass("drop-in-empty"), a.isIn) {
					var b = a.target.closest(".board").addClass("drop-in"), d = b.find(".board-item-shadow"), e = a.target;
	...
	"use strict";
	var b = "zui.datatable", c = (a.zui.store, function (c, d) {
	...
	c.DEFAULTS = {
		...
		if (a.isPlainObject(c))this.data = c; else if ("string" == typeof c) {
			var f = a(c);
		...
		if (!c) {
			...
			c = {cols: [], rows: []}, d = c.cols;
			var g, h, i, j, k, l, m = c.rows, n = this.$table;
			n.find("thead > tr:first").children("th").each(function () {
				...
				i = a(this), k = a.extend({
					...
					if (j = a(this), l = j.attr("colspan") || 1, k.data.push(a.extend({
							...
							text: j.html(),
							colSpan: l
						}, j.data())), l > 1)for (g = 1; l > g; g++)k.data.push({empty: !0})
				}), m.push(k)
			});
			var o = n.find("tfoot");
		...
		0 === c.flexStart && c.flexEnd === c.colsLength && (c.flexStart = -1, c.flexEnd = -1), c.flexArea = c.flexStart >= 0, c.fixedRight = c.flexEnd >= 0 && c.flexEnd < c.colsLength - 1, c.fixedLeft = c.flexStart > 0, c.flexStart < 0 && c.flexEnd < 0 && (c.fixedLeft = !0, c.flexStart = c.colsLength, c.flexEnd = c.colsLength), this.data = c, this.callEvent("afterLoad", {data: c}), this.render()
	}, c.prototype.render = function () {
		var c, d, e, f, g = this, h = g.$datatable || (g.isTable ? a('<div class="datatable" id="' + g.id + '"/>') : g.$datatable), i = g.options, j = g.data, k = g.data.cols, l = g.data.rows, m = i.checkable, n = '<div class="datatable-rows-span datatable-span"><div class="datatable-wrapper"><table class="table"></table></div></div>', o = '<div class="datatable-head-span datatable-span"><div class="datatable-wrapper"><table class="table"><thead></thead></table></div></div>';
		...
		var u, v, w, x, y, z, A, B, C = a('<div class="datatable-rows">'), D = l.length;
		...
		if (c.flexArea) {
			var o, p, q, r, s, t, u, v = f.find(".scroll-slide"), w = f.find(".datatable-span.flexarea"), x = f.find(".datatable-span.fixed-left"), y = f.find(".datatable-span.flexarea .table"), z = v.children(".bar"), A = b.id + "_scrollOffset";
		...
		if (d.checkable) {
			var E, F = b.id + "_checkedStatus", G = d.checkedClass, H = function () {
				var f = h.first().find(".table > tbody > tr"), g = f.filter("." + G);
				f.find(".check-row input:checkbox").prop("checked", !1);
				var j = {
					checkedAll: f.length === g.length && g.length > 0, checks: g.map(function () {
				...
				}), i.find(".check-all").toggleClass("checked", j.checkedAll), d.storage && e.pageSet(F, j), b.callEvent("checksChanged", {checks: j})
			};
		...
		if (d.fixedHeader) {
			var K, L, M, N = f.children(".datatable-head"), O = d.fixedHeaderOffset || a(".navbar.navbar-fixed-top").height() || 0, P = function () {
		...
		var c = a.zui.store, d = this.options, e = this.id + "_datatableSorter", f = d.storage ? c.pageGet(e) : null;
		if (b || (b = f ? this.$headCells.filter('[data-index="' + f.index + '"]').addClass("sort-" + f.type) : this.$headCells.filter(".sort-up, .sort-down").first()), b.length) {
			var g, h, i, j = this.data, k = j.cols, l = j.rows, m = this.$headCells;
			...
			a.each(l, function (b, c) {
				...
				index: i,
				type: g ? "up" : "down"
			}, d.storage && c.pageSet(e, f), this.callEvent("sort", {sorter: f})
		}
	}, c.prototype.refreshSize = function () {
		var b, c = this.$datatable, d = this.options, e = this.data.rows, f = this.data.cols;
		...
		}, h = this.$dataCells, i = this.$cells, j = this.$headCells;
		for (b = 0; b < f.length; ++b)i.filter('[data-index="' + b + '"]').css("width", f[b].width);
		var k = g(j);
		...
		return this.each(function () {
			var e = a(this), f = e.data(b), g = "object" == typeof d && d;
			f || e.data(b, f = new c(this, g)), "string" == typeof d && f[d]()
		})
	...
	function f(a) {
		...
		var c = a.h, d = a.s, e = a.l, f = a.a;
		c = i(c) % 360 / 360, d = h(i(d)), e = h(i(e)), f = h(i(f));
		var g = .5 >= e ? e * (d + 1) : e + d - e * d, j = 2 * e - g, k = {
			r: 255 * b(c + 1 / 3),
			g: 255 * b(c),
			b: 255 * b(c - 1 / 3),
			a: f
	...
	var j = /^#([0-9a-fA-f]{3}|[0-9a-fA-f]{6})$/, k = {
		aliceblue: "#f0f8ff",
		antiquewhite: "#faebd7",
		aqua: "#00ffff",
		aquamarine: "#7fffd4",
		...
		if (this.r = 0, this.g = 0, this.b = 0, this.a = 1, void 0 !== e && (this.a = h(i(e), 1)), void 0 !== a && void 0 !== b && void 0 !== c)this.r = parseInt(h(i(a), 255)), this.g = parseInt(h(i(b), 255)), this.b = parseInt(h(i(c), 255)); else if (void 0 !== a) {
			var g = typeof a;
			if ("string" == g)a = a.toLowerCase(), "transparent" === a ? this.a = 0 : this.rgb(k[a] ? d(k[a]) : d(a)); else if ("number" == g && void 0 === b)this.r = parseInt(h(a, 255)), this.g = this.r, this.b = this.r; else if ("object" == g && a.hasOwnProperty("r"))this.r = parseInt(h(i(a.r), 255)), a.hasOwnProperty("g") && (this.g = parseInt(h(i(a.g), 255))), a.hasOwnProperty("b") && (this.b = parseInt(h(i(a.b), 255))), a.hasOwnProperty("a") && (this.a = h(i(a.a), 1)); else if ("object" == g && a.hasOwnProperty("h")) {
				var j = {h: h(i(a.h), 360), s: 1, l: 1, a: 1};
	...
	l.prototype.rgb = function (a) {
		if (void 0 !== a) {
			if ("object" == typeof a)a.hasOwnProperty("r") && (this.r = parseInt(h(i(a.r), 255))), a.hasOwnProperty("g") && (this.g = parseInt(h(i(a.g), 255))), a.hasOwnProperty("b") && (this.b = parseInt(h(i(a.b), 255))), a.hasOwnProperty("a") && (this.a = h(i(a.a), 1)); else {
				var b = parseInt(i(a));
		...
		var b = this.toHsl(), c = (b.h + a) % 360;
		return b.h = 0 > c ? 360 + c : c, this.rgb(f(b)), this
	}, l.prototype.toHsl = function () {
		var a, c, d = this.r / 255, e = this.g / 255, f = this.b / 255, g = this.a, h = b.max(d, e, f), i = b.min(d, e, f), j = (h + i) / 2, k = h - i;
		if (h === i)a = c = 0; else {
		...
		return {h: 360 * a, s: c, l: j, a: g}
	}, l.prototype.luma = function () {
		var a = this.r / 255, c = this.g / 255, d = this.b / 255;
		...
		if (b = "undefined" == typeof b ? new l(255, 255, 255, 1) : new l(b), a = "undefined" == typeof a ? new l(0, 0, 0, 1) : new l(a), this.a < .5)return a;
	...
	}, l.prototype.isColor = e, a.zui({Color: l})
}(jQuery, Math, window), function (a, b) {
	"use strict";
	var c = "zui.calendar", d = "number", e = "string", f = "undefined", g = {
		primary: 1,
		green: 2,
		red: 3,
		blue: 4,
		...
		b = b || 1;
		for (var c = a.clone(); c.getDay() != b;)c.addDays(-1);
		return c.clearTime(), c
	}, i = function (a) {
		var b = a.clone();
		return b.setDate(1), b
	}, j = function (a, b) {
		var c = a.clone().clearTime(), d = b.clone().clearTime();
		return Math.round((d.getTime() - c.getTime()) / Date.ONEDAY_TICKS) + 1
	}, k = function (a, b, c) {
		for (var d = a.clone(), e = 0; b >= d;)c(d.clone(), e++), d.addDays(1)
	}, l = function (b, d) {
		if (this.name = c, this.$ = a(b), this.id = this.$.attr("id") || c + a.zui.uuid(), this.$.attr("id", this.id), this.storeName = c + "." + this.id, this.getOptions(d), this.getLang(), this.data = this.options.data, this.addCalendars(this.data.calendars), this.addEvents(this.data.events), this.sortEvents(), this.storeData = a.zui.store.pageGet(this.storeName, {
			...
			e.length || (e = a('<header><div class="btn-toolbar"><div class="btn-group"><button type="button" class="btn btn-today">{today}</button></div><div class="btn-group"><button type="button" class="btn btn-prev"><i class="icon-chevron-left"></i></button><button type="button" class="btn btn-next"><i class="icon-chevron-right"></i></button></div><div class="btn-group"><span class="calendar-caption"></span></div></div></header>'.format(this.lang)),
				this.$.append(e)), this.$caption = e.find(".calendar-caption"), this.$todayBtn = e.find(".btn-today"), this.$header = e
		}
	...
	l.DEFAULTS = {
		...
		data: {calendars: {defaultCal: {color: "#229F24"}}, events: []},
		limitEventTitle: !0,
		storage: !0,
		withHeader: !0,
		dragThenDrop: !0
		...
		d.calendars || (d.calendars = {}), a.isPlainObject(b) && (b = [b]), a.each(b, function (b, e) {
			if (c || d.callEvent("beforeAddCalendars", {newCalendar: e, data: d.data})) {
				if (e.color || (e.color = "primary"), g[e.color.toLowerCase()])e.presetColor = !0; else {
					var f = new a.zui.Color(e.color);
					e.textColor = f.contrast().hexStr()
				}
				d.calendars[e.name] = e
			}
		}), c || (d.display(), d.callEvent("addCalendars", {newCalendars: b, data: d.data}))
	}, l.prototype.addEvents = function (b, c) {
		var g = this;
		g.events || (g.events = []), a.isPlainObject(b) && (b = [b]), a.each(b, function (b, h) {
			if (c || g.callEvent("beforeAddEvent", {newEvent: h, data: g.data})) {
				var i = typeof h.start, k = typeof h.end;
		...
		}), c || (g.sortEvents(), g.display(), g.callEvent("addEvents", {newEvents: b, data: g.data}))
	}, l.prototype.getEvent = function (a) {
		for (var b = this.events, c = 0; c < b.length; c++)if (b[c].id == a)return b[c];
		return null
	}, l.prototype.updateEvents = function (b) {
		var c = {data: this.data, changes: []}, d = this;
		...
		a.each(b, function (b, i) {
			f = i.event, g = i.changes, h = {
				...
				d.callEvent("beforeChange", {
					...
					to: c.to,
					from: f[c.change]
				}) && (h.changes.push(a.entend(!0, {}, c, {from: f[c.change]})), f[c.change] = c.to)
			})), c.changes.push(h)
		}), d.sortEvents(), d.display(), d.callEvent("change", c)
	}, l.prototype.removeEvents = function (b) {
		a.isArray(b) || (b = [b]);
		var c, d, e, f = this.events, g = this, h = [];
		a.each(b, function (b, i) {
			c = a.isPlainObject(i) ? i.id : i, e = -1;
			for (var j = 0; j < f.length; j++)if (f[j].id == c) {
				e = j, d = f[j];
				break
			}
		...
		}), g.sortEvents(), g.display(), g.callEvent("removeEvents", {removedEvents: h, data: g.data})
		...
		var d = this, g = typeof b, h = typeof c;
		...
		var c = this;
		b = b || c.date;
		var d, e = c.options, f = c, g = c.lang, j = c.$views, k = c.$, l = f.$monthView;
		if (!l.length) {
			...
			var m, n = l.find(".week-head"), o = l.find(".month-days");
			for (d = 0; 7 > d; d++)n.append("<th>" + g.weekNames[d] + "</th>");
			for (d = 0; 6 > d; d++) {
				m = a('<tr class="week-days"></tr>');
				for (var p = 0; 7 > p; p++)m.append('<td class="cell-day"><div class="day"><div class="heading"><span class="month"></span> <span class="number"></span></div><div class="content"><div class="events"></div></div></div></td>');
				o.append(m)
			}
			j.append(l), f.$monthView = l
		}
		var q, r, s, t, u, v, w, x, y, z, A, B = l.find(".week-days"), C = l.find(".day"), D = i(b), E = new Date, F = h(D), G = b.getFullYear(), H = b.getMonth(), I = E.getMonth(), J = E.getFullYear(), K = E.getDate(), L = F.clone().addDays(42).addMilliseconds(-1), M = F.clone().addDays(1).addMilliseconds(-1), N = c.getEvents(F, L), O = c.calendars;
		B.each(function (b) {
			q = a(this), q.find(".day").each(function (c) {
				...
				var e = N[w];
				if (e) {
					var f, h = e.events, i = 0;
					for (d = 0; d <= e.maxPos; ++d)f = h[d], !f || f.placeholder && !x ? i++ : (y = a('<div data-id="' + f.id + '" class="event" title="' + f.desc + '"><span class="time">' + f.start.format("hh:mm") + '</span> <span class="title">' + f.title + "</span></div>"), y.find(".time").toggle(!f.allDay), y.data("event", f), y.attr("data-days", f.days), f.calendar && (z = O[f.calendar], z && (z.presetColor ? y.addClass("color-" + z.color) : y.css({
			...
			drop: function (a) {
				var b = a.element.data("event"), d = a.target.attr("data-date"), e = b.start.clone();
				if (e.toDateString() != d && (d = new Date(d), d.setHours(e.getHours()), d.setMinutes(e.getMinutes()), d.setSeconds(e.getSeconds()), f.callEvent("beforeChange", {
					...
					b.end.addMilliseconds(b.end.getTime() - e.getTime()), b.start = d, c.display(), f.callEvent("change", {
						...
						changes: [{
							event: b,
							changes: [{change: "start", from: e, to: b.start}, {change: "end", from: g, to: b.end}]
						}]
					})
				}
			},
		...
		var d = {}, e = (this.calendars, function (a, b, c) {
			var e = a.toDateString(), f = d[e];
			if (f || (f = {
					maxPos: -1,
					events: {}
				}), "undefined" == typeof c)for (var g = 0; 100 > g; ++g)if (!f.events[g]) {
				c = g;
				break
			}
		...
		return a.each(this.events, function (d, f) {
			if (f.start >= b && f.start <= c) {
				var g = e(f.start, f);
				if (f.days > 1) {
					var h = a.extend({placeholder: !0}, f);
					k(f.start.clone().addDays(1), f.end, function (b, c) {
						e(b.clone(), a.extend({holderPos: c}, h), g)
					})
				}
			}
		}), d
		...
		return this.each(function () {
			var d = a(this), f = d.data(c), g = "object" == typeof b && b;
		...
		if ("string" == typeof b.data) {
			...
			b.handler = function (b) {
				if (this === b.target || !/textarea|select/i.test(b.target.nodeName) && "text" !== b.target.type) {
					...
					for (var i = 0, j = d.length; j > i; i++)if (h[d[i]])return c.apply(this, arguments)
				}
			}
		}
	}
	...
	b.DEFAULTS = {
		...
		if (this.bindTrigger(c), a.isArray(c.triggers))for (b in c.triggers)this.bindTrigger(a.extend({}, c, c.triggers[b])); else if ("string" == typeof c.triggers) {
		...
		c.$.on(b.events, b.selector, function (d) {
			var e = b.target && "self" != b.target ? a(b.target) : c.$, f = {
				event: d,
				element: this,
				target: e,
				options: b
			...
			if (a.zui.callEvent(b.before, f, c)) {
				if (a.isFunction(b.trigger))a.zui.callEvent(b.trigger, f, c); else {
					var g = b.trigger;
					...
					switch (g) {
						...
						case"hide":
							h = {
								duration: b.animateSpeed, easing: b.easing, complete: function () {
									e.addClass("hide")
								}
		...
		return this.each(function () {
			var d = a(this), e = d.data("zui.autoTrigger"), f = "object" == typeof c && c;
			e || d.data("zui.autoTrigger", e = new b(this, f)), "string" == typeof c && e[c]()
		})
	}, a.fn.autoTrigger.Constructor = b, a(function () {
		a('[data-toggle="autoTrigger"]').autoTrigger(), a('[data-toggle="toggle"]').autoTrigger(), a('[data-toggle="show"]').autoTrigger({trigger: "show"}), a('[data-toggle="hide"]').autoTrigger({trigger: "hide"}), a('[data-toggle="addClass"]').autoTrigger({trigger: "addClass"}), a('[data-toggle="removeClass"]').autoTrigger({trigger: "removeClass"}), a('[data-toggle="toggleClass"]').autoTrigger({trigger: "toggleClass"})
	})
}(jQuery), function () {
	...
	d = function () {
		...
		return b.prototype.add_node = function (a) {
			...
			}), g = b.childNodes, h = [], e = 0, f = g.length; f > e; e++)d = g[e], h.push(this.add_option(d, c, b.disabled));
			return h
		...
		return a.prototype.set_default_values = function () {
			...
			for (this.selected_option_count = 0, d = this.form_field.options, b = 0, c = d.length; c > b; b++)a = d[b], a.selected && "" != a.value && (this.selected_option_count += 1);
		...
		return g(c, b), c.prototype.setup = function () {
			...
			var c, d, e = this;
			return c = a("<li />", {"class": "search-choice"}).html("<span title='" + b.html + "'>" + b.html + "</span>"), b.disabled ? c.addClass("search-choice-disabled") : (d = a("<a />", {
	...
	b.DEFAULTS = {
		...
		b.on("chosen:showing_dropdown", function () {
			a(d + " .chosen-results .group-option").each(function () {
				var b = a(this).addClass("icon"), c = a(this).text();
				b.html('<i class="icon-' + c + '" title="' + c + '"></i>')
			})
		}).change(function () {
			var b = a(d + " .chosen-single > span"), e = a(this).val();
		...
		var b = this.options[a], c = '<optgroup label="' + this.lang[a] + '">';
		for (var d in b)c += this.getOptionHtml(b[d]);
		return c + "</optgroup>"
		...
		return this.each(function () {
			var d = a(this), e = d.data("zui.chosenIcons"), f = "object" == typeof c && c;
			e || d.data("zui.chosenIcons", e = new b(this, f)), "string" == typeof c && e[c]()
		})
	}, a.fn.chosenIcons.Constructor = b
}(jQuery), function (a) {
	"use strict";
	var b = 0, c = ["primary", "red", "yellow", "green", "blue", "purple", "brown", "dark"], d = {
		theme: "light",
		primary: "#3280fc",
		secondary: "#145ccd",
		pale: "#ebf2f9",
	...
	}, a.zui({colorset: d}), a.zui.Color && a.extend(a.zui.Color, d)
}(jQuery), function (a) {
	"use strict";
	var b = a && a.zui ? a.zui : this, c = (b.Chart, function (a) {
		this.canvas = a.canvas, this.ctx = a;
		var b = function (a, b) {
			return a["offset" + b] ? a["offset" + b] : document.defaultView.getComputedStyle(a).getPropertyValue(b)
		}, c = this.width = b(a.canvas, "Width"), e = this.height = b(a.canvas, "Height");
		a.canvas.width = c, a.canvas.height = e;
		var c = this.width = a.canvas.width, e = this.height = a.canvas.height;
	...
	}, n = d.amd = "function" == typeof define && define.amd, o = d.isNumber = function (a) {
	...
	c.instances = {}, c.Type = function (a, b, d) {
		...
		initialize: function () {
			...
			this.stop();
			var b = this.chart.canvas, c = C(this.chart.canvas), d = this.options.maintainAspectRatio ? c / this.chart.aspectRatio : D(this.chart.canvas);
		...
		draw: function () {
			...
			var b = this.caretPadding = 2, c = a.measureText(this.text).width + 2 * this.xPadding, d = this.fontSize + 2 * this.yPadding, e = d + this.caretHeight + b;
			...
			if (a.fillStyle = this.fillColor, this.custom)this.custom(this); else {
				switch (this.yAlign) {
					case"above":
		...
		initialize: function () {
			...
			var a = this.ctx.measureText(this.title).width, b = H(this.ctx, this.font, this.labels) + this.fontSize + 3, c = p([b, a]);
		...
		initialize: function () {
			...
			var b = (this.xLabelRotation > 0, this.width - (this.xScalePaddingLeft + this.xScalePaddingRight)), c = b / Math.max(this.valuesCount - (this.offsetGridLines ? 0 : 1), 1), d = c * a + this.xScalePaddingLeft;
			...
			this.display && (a.fillStyle = this.textColor, a.font = this.font, e(this.yLabels, function (e, f) {
				var g = this.endPoint - b * f, h = Math.round(g), i = this.showHorizontalLines;
				...
				var d = this.calculateX(c) + t(this.lineWidth), e = this.calculateX(c - (this.offsetGridLines ? .5 : 0)) + t(this.lineWidth), f = this.xLabelRotation > 0, g = this.showVerticalLines;
	...
	"use strict";
	var b = a && a.zui ? a.zui : this, c = b.Chart, d = c.helpers, e = {
	...
	c.Type.extend({
		name: "Line", defaults: e, initialize: function (b) {
			this.PointClass = c.Point.extend({
				...
				if (a.zui && a.zui.Color && a.zui.Color.get) {
					var e = a.zui.Color.get(c.color), f = e.toCssStr();
				...
				this.datasets.push(g), d.each(c.data, function (a, d) {
					...
					d.extend(a, {x: this.scale.calculateX(b), y: this.scale.endPoint}), a.save()
				}, this)
			}, this), this.render()
		}, update: function () {
			...
			var b = [], c = d.getRelativePosition(a);
			return d.each(this.datasets, function (a) {
			...
			var a = d.extend({height: this.chart.height, width: this.chart.width});
			this.scale.update(a)
		}, draw: function (a) {
			var b = a || 1;
			this.clear();
			var c = this.chart.ctx, e = function (a) {
				return null !== a.value
			}, f = function (a, b, c) {
			...
			this.scale.draw(b), d.each(this.datasets, function (a) {
				...
				d.each(a.points, function (a, c) {
					...
					if (0 === b)c.moveTo(a.x, a.y); else if (this.options.bezierCurve) {
						var d = g(a, h, b);
	...
	c.Type.extend({
		name: "Doughnut", defaults: e, initialize: function (a) {
			...
			var f = this.options, g = (b.endAngle + b.startAngle) / 2, h = f.scaleLabelPlacement;
			"inside" !== h && "outside" !== h && this.chart.width - this.chart.height > 50 && b.circumference < Math.PI / 36 && (h = "outside");
			var i = Math.cos(g) * b.outerRadius, j = Math.sin(g) * b.outerRadius, k = d.template(f.scaleLabel, {
			...
			var m = (l.measureText(k).width, this.chart.width / 2), n = this.chart.height / 2;
			if ("outside" === h) {
				var o = i >= 0, p = i + m, q = j + n;
				l.textAlign = o ? "left" : "right", l.measureText(k).width, i = o ? Math.max(m + b.outerRadius + 10, i + 30 + m) : Math.min(m - b.outerRadius - 10, i - 30 + m);
				var r = f.scaleFontSize, s = Math.round((.8 * j + n) / r) + 1, t = Math.floor(this.chart.width / r) + 1;
				for (e[o ? s : -s] && (s > 1 ? s-- : s++); e[o ? s : -s] && t > s;)s++;
				if (e[s])return;
			...
			} else i = .6 * i + m, j = .6 * j + n, l.fillStyle = a.zui && a.zui.Color ? new a.zui.Color(b.fillColor).contrast().toCssStr() : "#fff";
			l.fillText(k, i, j)
		}, draw: function (a) {
			var b = a ? a : 1;
			this.clear();
		...
		name: "Pie",
		defaults: d.merge(e, {percentageInnerCutout: 0})
	...
	c.Type.extend({
		name: "Bar", defaults: e, initialize: function (b) {
			var e = this.options;
			this.ScaleClass = c.Scale.extend({
				offsetGridLines: !0, calculateBarX: function (a, b, c) {
					var d = this.calculateBaseWidth(), f = this.calculateX(c) - d / 2, g = this.calculateBarWidth(a);
				...
				if (a.zui && a.zui.Color && a.zui.Color.get) {
					var f = a.zui.Color.get(c.color), g = f.toCssStr();
					c.fillColor || (c.fillColor = f.clone().fade(50).toCssStr()), c.strokeColor || (c.strokeColor = g)
				}
				var h = {label: c.label || null, fillColor: c.fillColor, strokeColor: c.strokeColor, bars: []};
			...
			for (var b, c = [], e = d.getRelativePosition(a), f = function (a) {
				c.push(a.bars[b])
			}, g = 0; g < this.datasets.length; g++)for (b = 0; b < this.datasets[g].bars.length; b++)if (this.datasets[g].bars[b].inRange(e.x, e.y))return d.each(this.datasets, f), c;
			return c
		}, buildScale: function (a) {
